...
var config = require('../_core/config'),
    ...
    cardValidatorHandler = require('../services/cardValidator'),
...
AuthController.signUpPlan = function(req, res) {
    if(!req.body.parentID || !req.body.planID ) {
        ...
        var strDate = expirationDate.split('-'),
            expiryDate = strDate[1] + '/' + strDate[0];

        var validateCardData = {
